...
public class UnitOfWorkBehaviorTests
{
    ...
    public async Task Handle_QueryHasFailure_RollbackTransactionAndReturnsQueryFailure()
    {
        ...
        Result<DummyValue> resultFromPipeline =
            await unitOfWorkBehavior.Handle(dummyQuery, requestHandlerDelegateMock.Object, CancellationToken.None);
    ...
    public async Task Handle_CommandHasSuccess_SaveChangesAndCommitsTransactionAndReturnsCommandSuccess()
    {
        ...
        Result resultFromPipeline =
            await unitOfWorkBehavior.Handle(dummyCommand, requestHandlerDelegateMock.Object, CancellationToken.None);
